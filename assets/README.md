...
| File | Purpose |
| --- | --- |
| `ui-screens/00-login.png` | หน้าเข้าสู่ระบบ พร้อม SSO, guest mode และทางเข้าฉุกเฉินโดยไม่ต้องล็อกอิน |
...
- `Sign in` ตรวจข้อมูลและเปิด `01-dashboard-overview.png` เมื่อสำเร็จ
- `Forgot password?` เปิดขั้นตอนยืนยันอีเมลและตั้งรหัสผ่านใหม่
- `Continue with SSO` เริ่มขั้นตอนเข้าสู่ระบบขององค์กร
- `Create an account` เปิดหน้าสมัครสมาชิก
- `Continue as guest` เปิดโหมดวางแผนทริปแบบจำกัดโดยยังไม่บันทึกข้อมูลส่วนตัว
- `Open Emergency Center` เปิด `05-emergency-center.png` ทันทีโดยไม่ต้องยืนยันตัวตน
...
- `login/` — asset pack เฉพาะหน้า Login พร้อม background, logo, mascot, route overlay, corner decoration, icon files และ `manifest.json`
